...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    spawn(function()
      ...
      if Third_Sea then
      local RoughSea = Tabs.SeaEvents:AddSection("Kitsune")
      ...
      local ToggleCollectAzure = Tabs.SeaEvent:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Embers", Default = false })
...
local ToggleTweenMirageIsland = Tabs.SeaEvent:AddToggle("ToggleTweenMirageIsland", {Title = "Tween To Mirage Island", Default = false })
