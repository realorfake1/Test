...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://112488065409239",
...
_G.FastAttack = true    
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Auto Farm Near", Default = false })
...
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local TurnV3 = Tabs.Setting:AddToggle("ToggleAutoT", {Title = "Turn On V3" , Default = false })
    ...
    local TurnV4 = Tabs.Setting:AddToggle("ToggleAutoY", {Title = "Turn On V4", Default = false })
