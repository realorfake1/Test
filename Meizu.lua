...
spawn(function()
    ...
    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {Title = "Auto Farm Level", Description = "Level Farm", Default = false })
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Auto Farm Nearest", Description = "Farm Nearest Mobs", Default = false })
    ...
    local ToggleCastleRaid = Tabs.Main:AddToggle("ToggleCastleRaid", {Title = "Auto Castle Raid", Description = "Auto Finish Pirate Raid", Default = false })
...
local boss = Tabs.Main:AddSection("Boss Farm")
	...
	local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {Title = "Auto Kill Boss", Description = "Kill Boss Selected", Default = false })
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {Title = "Auto Farm Material", Description = "Farm Material Selected", Default = false })
    ...
    spawn(function()
      ...
      if Third_Sea then
      local KitsuneIsland = Tabs.SeaEvents:AddSection("Kitsune")


      local ToggleEspKitsune = Tabs.SeaEvents:AddToggle("ToggleEspKitsune", {Title = "ESP Kitsune Island", Default = false })
      ...
      local ToggleTPKitsune = Tabs.SeaEvents:AddToggle("ToggleTPKitsune", {Title = "Tween To Kitsune Island", Default = false })
      ...
      local ToggleCollectAzure = Tabs.SeaEvents:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Embers", Default = false })
...
spawn(function()
    ...
    if Third_Sea then
    local RoughSea = Tabs.SeaEvents:AddSection("Rough Sea")
    local ToggleSeaBeAst = Tabs.SeaEvents:AddToggle("ToggleSeaBeAst", {Title = "Auto Sea Beast", Default = false })
...
ToggleSeaBeAst:OnChanged(function(Value)
    ...
    local ToggleSailBoat = Tabs.SeaEvents:AddToggle("ToggleSailBoat", {Title = "Auto Buy Ship", Default = false })
    ...
    local ToggleTerrorshark = Tabs.SeaEvents:AddToggle("ToggleTerrorshark", {Title = "Auto Kill Terrorshark", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.SeaEvents:AddToggle("TogglePiranha", {Title = "Auto Kill Piranha", Default = false })
     ...
     local ToggleShark = Tabs.SeaEvents:AddToggle("ToggleShark", {Title = "Auto Kill Shark", Default = false })
    ...
    local ToggleFishCrew = Tabs.SeaEvents:AddToggle("ToggleFishCrew", {Title = "Auto Kill Fish Crew", Default = false })
    ...
    local ToggleShip = Tabs.SeaEvents:AddToggle("ToggleShip", {Title = "Auto Ship", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.SeaEvents:AddToggle("ToggleGhostShip", {Title = "Kill Ghost Ship", Default = false })
        ...
        while wait() do
            pcall(function()
                if (game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban")) then
                    StatusElite:SetContent("Elite Boss: 🟢 | Killed:  " .. game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress"))
                else
                    StatusElite:SetContent("Elite Boss: 🔴 | Killed: " .. game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress"))
                end
            end)
...
if Third_Sea then
    ...
    local AutoMysticIsland = Tabs.SeaEvents:AddSection("Mirage Island")

local ToggleTweenMirageIsland = Tabs.SeaEvents:AddToggle("ToggleTweenMirageIsland", {Title = "Tween To Mirage Island", Default = false })
...
local ToggleTweenGear = Tabs.SeaEvents:AddToggle("ToggleTweenGear", {Title = "Tween To Gear", Default = false })
...
spawn(function()
    ...
    local TeleportToAdvancedFruitDealer = Tabs.SeaEvents:AddToggle("ToggleTpAdvanced", {
    	Title = "TP To Advanced Fruit Dealer",
        Description = "",
        Default = false
    });
    ...
    local Togglelockmoon = Tabs.SeaEvents:AddToggle("Togglelockmoon", {Title = "Lock Moon and Use Race Skill", Default = false })
 ...
 local AutoW = Tabs.SeaEvents:AddToggle("AutoW", {Title = "Auto Press W", Default = false })
...
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local TurnV3 = Tabs.Setting:AddToggle("ToggleAutoT", {Title = "Auto Active Race V3" , Default = false })
    ...
    local TurnV4 = Tabs.Setting:AddToggle("ToggleAutoY", {Title = "Auto Active Race V4", Default = false })
...
local Teleport = Tabs.Teleport:AddSection("Teleport To World")
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto Awaken", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Get Fruit Low Beli", Default = false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Auto Trial [UPDATE]", Default = false })
