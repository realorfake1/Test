game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Cokka Hub";
    Text = "By Nttphu1721"; -- what the text says (ofc)
    Duration = 9;
})
...
local L_34_ = L_33_:Window("Cokka Hub by Nttphu1721", Enum.KeyCode.LeftControl)
...
Notify("<Color=White>Hello, Welcome To MeizuHub<Color=/>", 10)
Notify("<Color=Blue>Nttphu1721<Color=/>", 8)