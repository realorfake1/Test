...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=132336058081263";
v24.Parent = v23;
                        ...
                        if (v1433:FindFirstChild("Humanoid") and v1433:FindFirstChild("HumanoidRootPart") and (v1433.Humanoid.Health > 0)) then
                            if (v1433.Name == Ms) then
                                repeat
                                    ...
                                    Tween(v1433.HumanoidRootPart.CFrame * CFrame.new(posX,posY,posZ));
                    ...
                    for v1434, v1435 in pairs(game:GetService("Workspace")['_WorldOrigin'].EnemySpawns:GetChildren()) do
                        if string.find(v1435.Name, NameMon) then
                            if ((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v1435.Position).Magnitude >= 10) then
                                Tween(v1435.CFrame * CFrame.new(posX,posY,posZ));
                            end
                        end
                    end
                end
...
local v51 = v16.Main:AddToggle("ToggleCastleRaid", {
    ...
    Description = "Auto Finish Pirate Raid",
    Default = false
});
...
local v56 = v16.Main:AddSection("Mastery Farm");
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("Bones: " .. tostring(v768) .. "");
            end
        end);
    end);
        ...
        while wait() do
            pcall(function()
                if (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88) then
                    v491:SetDesc("Katakuri: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 41) .. "");
                elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87) then
                    v491:SetDesc("Katakuri: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 40) .. "");
                elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86) then
                    v491:SetDesc("Katakuri: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 39) .. " ");
                else
                    v491:SetDesc("Katakuri : 🟢");
                end
            end);
        end
    end);
...
local katakuristatus = v16.Status:AddParagraph({
	Title = "Katakuri",
    Content = ""
});
spawn(function()
    while wait() do
        pcall(function()
            if (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88) then
                katakuristatus:SetDesc("" .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 41) .. "");
            elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87) then
                katakuristatus:SetDesc("" .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 40) .. "");
            elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86) then
                katakuristatus:SetDesc("" .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 39) .. " ");
            else
                katakuristatus:SetDesc("🟢");
            end
        end);
    end
end);
local elitestatus = v16.Status:AddParagraph({
	Title = "Elite Hunter",
    Content = ""
});
spawn(function()
...
local miragestatus = v16.Status:AddParagraph({
    Title = "Mirage Island",
    Content = ""
});
task.spawn(function()
...
spawn(function()
    pcall(function()
        while wait() do
            miragestatus:SetDesc("" .. MirageStatus .. "");
        end
    end);
end);
local kitsunestatus = v16.Status:AddParagraph({
    Title = "Kitsune Island",
    Content = ""
});
function KitsuneStatus()
    if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
        kitsunestatus:SetDesc("🟢");
    else
        kitsunestatus:SetDesc("🔴");
    end
end
